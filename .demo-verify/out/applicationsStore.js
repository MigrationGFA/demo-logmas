...
exports.LEGACY_APPLICATIONS_EVENT_KEY = exports.APPLICATIONS_EVENT_KEY = exports.LEGACY_APPLICATIONS_STORAGE_KEY = exports.APPLICATIONS_STORAGE_KEY = void 0;
exports.getLgaApplications = getLgaApplications;
exports.saveLgaApplications = saveLgaApplications;
exports.getLgaApplicationById = getLgaApplicationById;
exports.createLgaApplication = createLgaApplication;
exports.linkApplicationInvoice = linkApplicationInvoice;
exports.updateApplicationStatus = updateApplicationStatus;
exports.processApplicationPayment = processApplicationPayment;
exports.recordFieldInspection = recordFieldInspection;
exports.issueTreasuryInvoice = issueTreasuryInvoice;
exports.approveAndGenerateCertificate = approveAndGenerateCertificate;
exports.reapplyFromRejected = reapplyFromRejected;
const store_1 = require("./store");
const lga_config_1 = require("@/config/lga.config");
exports.APPLICATIONS_STORAGE_KEY = `${lga_config_1.LGA_CONFIG.identity.id}_applications`;
exports.LEGACY_APPLICATIONS_STORAGE_KEY = "legacy_applications";
exports.APPLICATIONS_EVENT_KEY = `${lga_config_1.LGA_CONFIG.identity.id}:applications-change`;
exports.LEGACY_APPLICATIONS_EVENT_KEY = "lga:applications-change";
const STORAGE_KEY = exports.APPLICATIONS_STORAGE_KEY;
const EVT_KEY = exports.APPLICATIONS_EVENT_KEY;
const INITIAL_SEED_APPLICATIONS = [
    {
        ...
        address: `12 Camp Road, Obantoko, ${lga_config_1.LGA_CONFIG.identity.formalTitle}`,
        ...
        issuedBy: `${lga_config_1.LGA_CONFIG.leadership.chairman.name} (${lga_config_1.LGA_CONFIG.leadership.chairman.title})`,
        ...
        timeline: [
            ...
            { id: "t4", stage: "Payment Confirmed", title: "Payment Received", description: "₦3,500 paid via Online Gateway. Receipt DEMO/RCP/2026/000101 issued.", actor: "Adebayo Citizen", actorRole: "citizen", timestamp: "2026-08-01 10:00", status: "completed" },
            ...
            { id: "t6", stage: "Certificate Generated", title: "Certificate Issued", description: "Official Certificate DEMO/COO/2026/000001 ready for download", actor: "System", actorRole: "system", timestamp: "2026-08-02 11:00", status: "completed" },
        ],
    },
    {
        id: "DEMO-2026-002",
        ...
        address: `Plot 14 Commercial Row, Camp Junction, ${lga_config_1.LGA_CONFIG.identity.name}`,
        ward: "Ward 7 (Itesi / Camp)",
        ...
        timeline: [
            ...
            { id: "t3", stage: "Invoice Generated", title: "Demand Notice Issued", description: "Invoice DEMO/INV/2026/000102 for ₦25,000 issued by Treasury. Awaiting payment.", actor: "Treasury", actorRole: "treasurer", timestamp: "2026-08-04 14:00", status: "current" },
        ],
    },
    {
        id: "DEMO-2026-003",
        ...
        applicant: `${lga_config_1.LGA_CONFIG.identity.name} Farmers Cooperative (Kazeem)`,
        phone: "08012345678",
        email: `farmers@${lga_config_1.LGA_CONFIG.contact.email.split("@")[1] || "lga.gov.ng"}`,
        ...
        timeline: [
            ...
            { id: "t2", stage: "Payment Confirmed", title: "Payment Received", description: "₦5,000 paid via Field POS. Receipt DEMO/RCP/2026/000103 issued.", actor: "Field Officer", actorRole: "field_officer", timestamp: "2026-08-05 09:00", status: "completed" },
    ...
    {
        id: "DEMO-2026-004",
        applicationNo: "DEMO/LIQ/2026/0004",
    ...
    {
        id: "DEMO-2026-005",
        applicationNo: "DEMO/QUA/2026/0005",
    ...
    {
        id: "DEMO-2026-006",
        applicationNo: "DEMO/CLU/2026/0006",
    ...
    {
        id: "DEMO-2026-007",
        applicationNo: "DEMO/KIO/2026/0007",
    ...
    {
        id: "DEMO-2026-008",
        applicationNo: "DEMO/CDA/2026/0008",
...
function getLgaApplications() {
    if (typeof window === "undefined")
        return INITIAL_SEED_APPLICATIONS;
    try {
        const raw = window.localStorage.getItem(STORAGE_KEY) || window.localStorage.getItem(exports.LEGACY_APPLICATIONS_STORAGE_KEY);
        if (!raw) {
...
function saveLgaApplications(apps) {
    if (typeof window === "undefined")
        return;
    try {
        window.localStorage.setItem(STORAGE_KEY, JSON.stringify(apps));
        window.dispatchEvent(new CustomEvent(EVT_KEY));
        window.dispatchEvent(new CustomEvent(exports.LEGACY_APPLICATIONS_EVENT_KEY));
    }
    catch (err) {
        console.error("Failed to save applications", err);
    }
}
function getLgaApplicationById(id) {
    const apps = getLgaApplications();
    return apps.find((a) => a.id === id || a.applicationNo === id);
}
function createLgaApplication(data) {
    const apps = getLgaApplications();
    const count = apps.length + 101;
    const shortCode = lga_config_1.LGA_CONFIG.identity.shortCode || "DEMO";
    ...
    const initialStatus = data.isDraft ? "Draft" : "Submitted";
    const newApp = {
        id,
        applicationNo: appNo,
        ...
        paymentStatus: "unpaid",
        qrToken: (0, store_1.genQRToken)(),
        verificationCode: (0, store_1.genVerificationCode)(),
        createdAt: now,
        updatedAt: now,
 ...
 */
function linkApplicationInvoice(id, invoiceId, invoiceNumber) {
    const apps = getLgaApplications();
    ...
    (0, store_1.addAudit)({ actor: "System", actorRole: "system", action: "APPLICATION_INVOICE_LINKED", target: updated.applicationNo, meta: { invoiceId, invoiceNumber } });
    return updated;
}
function updateApplicationStatus(id, newStatus, actorInfo, updates = {}) {
    const apps = getLgaApplications();
    const index = apps.findIndex((a) => a.id === id || a.applicationNo === id);
    if (index === -1)
        return null;
    ...
    const updatedTimeline = (current.timeline || []).map((t) => ({ ...t, status: "completed" }));
    // Add new stage event
...
function processApplicationPayment(id, paymentMethod = "card", actorInfo) {
    const app = getLgaApplicationById(id);
    if (!app)
        return null;
    const invRef = app.invoiceNumber || (0, store_1.genInvoiceRef)();
    const rctRef = (0, store_1.genReceiptNumber)();
    const now = new Date().toISOString();
...
function recordFieldInspection(id, inspection, officerInfo) {
    const now = new Date().toISOString();
...
function issueTreasuryInvoice(id, assessment, treasurerInfo) {
    const invNo = (0, store_1.genInvoiceRef)();
    const now = new Date().toISOString();
...
function approveAndGenerateCertificate(id, adminInfo) {
    const app = getLgaApplicationById(id);
    if (!app)
        return null;
    const now = new Date().toISOString();
    const certNo = `DEMO/${app.serviceId.substring(0, 3).toUpperCase()}/2026/${Math.floor(100000 + Math.random() * 899999)}`;
...
function reapplyFromRejected(id, citizenName) {
    const app = getLgaApplicationById(id);
    if (!app)
        return null;
